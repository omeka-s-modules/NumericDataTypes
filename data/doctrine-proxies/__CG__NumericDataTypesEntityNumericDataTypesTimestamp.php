 ...
 */
class NumericDataTypesTimestamp extends \NumericDataTypes\Entity\NumericDataTypesTimestamp implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NumericDataTypesTimestamp $proxy) {
