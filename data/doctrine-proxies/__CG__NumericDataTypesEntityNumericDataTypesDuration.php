 ...
 */
class NumericDataTypesDuration extends \NumericDataTypes\Entity\NumericDataTypesDuration implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NumericDataTypesDuration $proxy) {
