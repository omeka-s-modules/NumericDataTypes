...
namespace DoctrineProxies\__CG__\NumericDataTypes\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class NumericDataTypesInterval extends \NumericDataTypes\Entity\NumericDataTypesInterval implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'value', 'value2', 'id', 'resource', 'property'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NumericDataTypesInterval $proxy) {
    ...
    public function setValue2($value2)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setValue2', [$value2]);

        return parent::setValue2($value2);
    }
    ...
    public function getValue2()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getValue2', []);

        return parent::getValue2();
    }
