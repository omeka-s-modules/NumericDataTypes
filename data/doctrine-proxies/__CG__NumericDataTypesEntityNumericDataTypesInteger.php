 ...
 */
class NumericDataTypesInteger extends \NumericDataTypes\Entity\NumericDataTypesInteger implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NumericDataTypesInteger $proxy) {
